                    ...
                    for ui,pos in ui_map[page].items():
                        if ui==next_page:
                            ...
                            if type(pos[0])==tuple:
                                ...
                                sleep(1)
                else:log.info(f'{page} not in ui_map')
